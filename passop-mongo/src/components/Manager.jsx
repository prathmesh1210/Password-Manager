...
const Manager = () => {
    ...
    const deletepassword= async(id)=>{
        ...
        if (c){
            ...
            let res =await fetch ( "http://localhost:3000/" , {method :"DELETE " , headers :{ "content-Type" : "application/json"} , body :JSON.stringify({...form , id :id})})
        ...
        <>
            ...
            <div className="  bg-slate-50 mycontainer  ">
                ...
                <div className=" text-black flex flex-col p-4 text-black gap-8 items-center">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 w-full justify-center gap-8 text-black">
